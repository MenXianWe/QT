...
/******主机状态3按钮******/
//状态
void MainWindow::on_hStatePushButton_clicked()
{
    if(resultState==1)
    {
...
//电压
void MainWindow::on_volPushButton_clicked()
{
    if(resultState==1)
    {
...
//电压
void MainWindow::on_dePushButton_clicked()
{
    if(resultState==1)
    {
        QString hexStr=tempData.toHex();
...
/******灯的状态******/
void MainWindow::on_lightOpenPushButton_clicked()
{
    openLightF();
}

void MainWindow::on_lightClosePushButton_clicked()
{
    closeLightF();
}

void MainWindow::on_allClosePushButton_clicked()
{
...
void MainWindow::on_allOpenPushButton_clicked()
{
...
//广播
void MainWindow::on_broadCastPushButton_clicked()
{
